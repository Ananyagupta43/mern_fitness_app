...
const BMR = ({ person }) => {
    ...
    return <div style={{ padding: " 30px 50px" }} >
        ...
        <h4 className="heading">BMR Variables</h4>
        <p><h5 className="heading">Muscle Mass –</h5>Aerobic exercises, such as running or cycling, have no effect on BMR. However, anaerobic exercises, such as weight-lifting, indirectly lead to a higher BMR because they build muscle mass, increasing resting energy consumption. The more muscle mass in the physical composition of an individual, the higher the BMR required to sustain their body at a certain level.</p>
        <p><h5 className="heading">Age – </h5>The more elderly and limber an individual, the lower their BMR, or the lower the minimum caloric intake required to sustain the functioning of their organs at a certain level.</p>
        <p><h5 className="heading">Genetics – </h5>Hereditary traits passed down from ancestors influence BMR.</p>
        <p><h5 className="heading">Weather – </h5>Cold environments raise BMR because of the energy required to create a homeostatic body temperature. Likewise, too much external heat can raise BMR as the body expends energy to cool off internal organs. BMR increases approximately 7% for every increase of 1.36 degrees Fahrenheit in the body's internal temperature.</p>
        <p><h5 className="heading">Diet –</h5>Small, routinely dispersed meals increase BMR. On the other hand, starvation can reduce BMR by as much as 30%. Similar to a phone that goes into power-saving mode during the last 5% of its battery, a human body will make sacrifices such as energy levels, moods, upkeep of bodily physique, and brain functions in order to more efficiently utilize what little caloric energy is being used to sustain it.</p>
        <p><h5 className="heading">Pregnancy – </h5>Ensuring the livelihood of a separate fetus internally increases BMR. This is why pregnant women tend to eat more than usual. Also, menopause can increase or decrease BMR depending on hormonal changes.</p>
        <p><h5 className="heading">Supplements – </h5>Certain supplements or drugs raise BMR, mostly to fuel weight loss. Caffeine is a common one.</p>
        <h4 className="heading">BMR Tests</h4>
        ...
        <h4 className="heading">Resting Metabolic Rate</h4>
        ...
        <h4 className="heading">Modern Wisdom</h4>
