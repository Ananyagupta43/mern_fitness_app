...
const ExerciseCard = ({ exercise }) => {
    ...
    return <div onClick={goToDetailPage} style={{ paddingTop: "10px", display: "flex", flexDirection: "column", alignItems: "center" }}>
        ...
        <div style={{
            textTransform: "capitalize", color: "black", padding: "8px", marginTop: "10px", fontFamily: 'MetropolisSemiBold', backgroundColor: "#dfdf3d", width: "100%", borderBottomLeftRadius: "13px",
            borderBottomRightRadius: "13px", textAlign: "center"
        }}>{exercise.name}</div>
    </div>
}
