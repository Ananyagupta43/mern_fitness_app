...
const HealthyWeightCalculator = ({ person }) => {
    ...
    return <div style={{ padding: " 30px 50px" }}>
        <h1 className="heading" >Healthy Weight Calculator</h1>
        ...
        <h4 className="heading">What is a Healthy Weight?</h4>
        ...
        <h4 className="heading">Effects of Being Underweight, Overweight, and Obese</h4><br />
        <h5 className="heading">Underweight (BMI &lt; 18.5):</h5>
        ...
        <h5 className="heading">Overweight (BMI 25-30):</h5>
        ...
        <h5 className="heading">Obese (BMI &gt; 30):</h5>
        ...
        <h4 className="heading">Maintaining a Healthy Weight</h4>
